...
**部署地址**：https://cloud1-5grxjpsy34de0f66-1369733527.tcloudbaseapp.com/

**修改内容**：

#### 1. 联系方式更新
- **页尾栏** (`src/components/Footer.tsx`)
  - 联系人：郭经理
  - 电话：15526386298
  - 邮箱：gxh15526386298@163.com
  - 地址：长沙市开福区万达广场C2座3914

- **联系我们页面** (`src/pages/ContactPage.tsx`)
  - 同步更新了所有联系信息
  - 增加了联系人字段

#### 2. 产品信息更新 (`src/data/products.ts`)

**产品名称和价格调整**：
- 芒芒很快乐 → **微醺杨枝甘露**（仅改名）
- 樱桃小丸子 → **香草话梅**（单杯成本3.7，建议售价42，主成分话梅）
- 孤寂冰川 → **柚柚红茶**（单杯成本4.2，建议售价52，主成分西柚）
- 莫吉托 → **玛格丽特**（20%，单杯成本9.3，建议售价98，主成分龙舌兰）
